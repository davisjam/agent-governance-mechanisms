...
<!-- point: the-shared-resource-is-the-only-cross-lifecycle-coupling-surface-and-keeps-the-graph-sparse | The shared resource is the only cross-lifecycle coupling surface. | terms: shared-resource, the-semantic-gap -->
...
<!-- section-terms: governance-graph, outside-hook -->
