...
this is the [semantic gap](2.2-models-and-the-semantic-gap.html) again — the collision is a property of
the *interaction*, invisible in either control's own code, legible only at the level where both are
drawn. The graph lifts the check to that level.
