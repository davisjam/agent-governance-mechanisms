...
<!-- point: the-fix-joins-a-traceability-graph-to-the-coverage-oracle | The fix joins a traceability graph to the coverage oracle. | terms: traceability, anchor -->
...
<!-- point: the-composition-counts-model-claims-and-reports-a-named-verdict | The composition counts model claims and reports a named verdict. | terms: coverage-model-mapping, anchor -->
...
<!-- point: one-primitive-supports-several-aggregations-each-a-different-decision | One primitive supports several aggregations, each a different decision. | terms: coverage-model-mapping, anchor -->
...
<!-- section-terms: doc-derived-test, soft-vs-hard-governance -->
