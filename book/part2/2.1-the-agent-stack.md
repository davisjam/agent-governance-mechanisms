...
representation of the board state living inside the network — and, more telling, it does not
just *read out* that representation but *causally intervenes* on it: flip the encoded state of a
