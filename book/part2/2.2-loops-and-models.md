...
A model earns its keep twice over here: it aims the search, and it shrinks what the agent
must hold in-window to run that search — the surest defense against the moment the work
outgrows the context window and the agent starts churning.
