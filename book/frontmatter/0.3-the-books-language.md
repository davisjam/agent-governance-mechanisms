...
**Engineering capital.** The stock Compounding accrues: coherent, economical, quality-bearing governance that lowers the recurring cost of change. Bureaucracy is its shadow — accumulation that adds friction without reducing future reasoning, so it never compounds; capital also depreciates once it outlives its fit, which is why mature adaptation retires and reconciles as well as adds.
