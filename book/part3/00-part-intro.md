...
continuously keeps true. Using Kruchten's four-plus-one views as an organizing spine, we build
a family of executable models over one real system, and show how derivation, traceability, and
drift gates let them evolve with the code rather than behind it. The goal is not to teach one
