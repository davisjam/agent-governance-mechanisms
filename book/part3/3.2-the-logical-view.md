...
flip side of that join is a *snapshot-ban lint*. Copying a registry value into code is itself a
finding, because the copy is where drift starts; the consumer must read the fact live or be
caught. That turns "keep the docs in sync" from a discipline into a
