...
fact agrees, because each joins to the registry by key rather than keeping its own copy. Copying
a registry value into code is itself a finding, because the copy is where drift starts; the
