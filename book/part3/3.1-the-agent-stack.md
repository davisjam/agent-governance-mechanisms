...
The stack is where the two engineering theses get their footing. A model handed to a layer
enacts the Binding Thesis, tying intent to implementation; a hook or lint installed at a
layer enacts the Control Thesis. The two chapters that follow take one thesis each.
