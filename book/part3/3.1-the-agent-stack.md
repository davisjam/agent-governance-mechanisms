...
The stack is where the book's two moves get their footing. A model handed to a layer binds
intent to implementation; a hook or lint installed at a layer is a governance mechanism.
The two chapters that follow take one move each.
