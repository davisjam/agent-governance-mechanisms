...
<!-- table: Model-sync evidence — the derived floor under load, model↔code sync only (documentation drift excluded by construction). [short: Model-sync evidence — the derived floor under load] -->
