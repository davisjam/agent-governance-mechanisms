...
<!-- figure: assets/model-sync-two-layer-net.svg | The model↔code gap spanned by the two-layer net, with two escape hatches drawn as gaps in the net. Derived defends, snapshotted drifts — and what isn't modeled can't drift-check. -->
