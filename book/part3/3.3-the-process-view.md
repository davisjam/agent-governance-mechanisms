...
invariants concurrency hands you whether you asked for them or not — the ones nobody writes down
until a lock ordering deadlocks a build at 2 a.m. Start with the locks themselves.
