...
> check one by visiting every reachable state and evaluating the predicate there (the invariant primer).
...
> checkers — a state search for the first, a temporal model checker for the second.
>
