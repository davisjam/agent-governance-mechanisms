...
<!-- label: three-skills -->
<!-- figure: assets/three-skills.svg | *The Three Skills.* One substrate, three complements: self-governance hardens it, self-operate runs it, self-communicate explains it — and the skills feed each other, a recurring break becoming a mechanism written in the register the third governs. -->
