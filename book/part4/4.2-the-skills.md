...
<!-- label: three-skills -->
<!-- figure: assets/three-skills.svg | One substrate, three complements: self-governance hardens it, self-operate runs it, self-communicate explains it — and the skills feed each other, a recurring break becoming a mechanism written in the register the third governs. -->
...
<!-- label: skill-recipe -->
<!-- figure: assets/skill-recipe.svg | Every shipped skill has the same skeleton: a base model of the domain, orthogonal models cutting it along independent axes, and a SKILL.md of principles that ties them into a working skill. -->
