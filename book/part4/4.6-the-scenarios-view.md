...
<!-- noqa: book-section-cap | The user-journey model — a model page rendered from the fixed five-field (a)-(e) template; the fields are one indivisible reference unit a reader scans by reflex across every model, so splitting one page breaks the uniform shape -->
...
<!-- noqa: book-section-cap | The agent-orchestration model — a model page rendered from the fixed five-field (a)-(e) template; the fields are one indivisible reference unit a reader scans by reflex across every model, so splitting one page breaks the uniform shape -->
...
<!-- noqa: book-section-cap | Journey-criticality → test-placement — a model page rendered from the fixed five-field (a)-(e) template; the fields are one indivisible reference unit a reader scans by reflex across every model, so splitting one page breaks the uniform shape -->
...
<!-- noqa: book-section-cap | Coverage → model-node mapping — a model page rendered from the fixed five-field (a)-(e) template (under the word cap; over the paragraph cap only because the template's bold-lead bullets each count as a paragraph); one indivisible reference unit -->
