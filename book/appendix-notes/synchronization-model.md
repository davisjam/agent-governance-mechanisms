...
unchecked one. And the model captures OS-level locks, not the higher-level single-writer and mediator
contracts of the same concurrency story, which need their own treatment.
