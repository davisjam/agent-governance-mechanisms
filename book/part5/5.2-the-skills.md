...
| Layer | For this skill | Remark |
|---|---|---|
| **Base model** | the catalogue of governance mechanisms — around sixty-six failure-killing patterns | the base is a census of failures and the control each one earns |
