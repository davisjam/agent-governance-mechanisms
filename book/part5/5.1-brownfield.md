...
log never shows. Multiply the two. High cost times high frequency earns a hard control — a
blocking lint, a gate, a typed seam that makes the mistake impossible. Low times low you
leave to judgment; a control there costs more attention to maintain than the failure ever
costs you. The middle band is where taste lives, and where you will spend it. This is also
when to *stop*: a control guarding a failure that is both rare and cheap is the first brick
