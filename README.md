...
<!-- summary: A pattern catalogue of the mechanisms for governable agentic software engineering — 83 across three roles. -->
...
- **[Constructing the Governed Engineering Environment](constructing-the-gee.md)** — the architecture
  behind the census: 8 principles, 9 capabilities, 25 canonical mechanisms, 8 compositions, and the
