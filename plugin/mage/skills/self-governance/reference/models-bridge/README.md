...
## The <!--census:bridge:word-->34<!--/census--> mechanisms — one method, two subjects (a Y)

The role is a **Y**: one **method** (the trunk) reified toward the two subjects the bridge couples — the
**product** it ships and the **orchestration** that builds it. The <!--census:bridge_method:word-->sixteen<!--/census--> method-mechanisms are
