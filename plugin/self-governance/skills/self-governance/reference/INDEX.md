...
the two); families **7–11** = the **product** role (the shipped artifact). All 37 bundled entries are fully written (the product role's entries live in the full catalogue).
