...
*Its place in the environment — the generative engine behind **Encoded Operational Judgment** and the **Governed Knowledge Base**, under **GOVERN · Govern the control estate itself**; the [construction kit](../../constructing-the-gee.md#cap-govern) shows how it folds.*
