...
### Lesson 2.3-the-governed-environment
  ...
  - **[DERIVED]** (apply) After this section, the reader can run the promotion rule for a season and the environment fills with …. — _anchor: ts: Run the promotion rule for a season and the environment fills with controls — nearly all o_
