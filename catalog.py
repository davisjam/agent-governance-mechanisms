...
LANDING_CSS = """
  ...
  .book-sub { color:var(--accent); font-weight:700; font-size:var(--fs-body); letter-spacing:.01em;
              margin:0 0 16px; }
  /* A STATIC in-flow pill row above the H1 — no longer position:absolute, so it can never overlap the
     hero figure's title at wide viewports (the review's one outright bug). A compact wrapping row of
     nav pills; the old 6-track grid + @media(820px) absolute-fallback are retired with the positioning. */
...
.site-foot .book-foot { white-space:nowrap; font-weight:600; }
  .loop { border:1px solid var(--line); border-radius:11px; padding:16px 17px 15px; margin:4px 0 20px; background:var(--panel); }
  .loop .hd { margin:0 0 12px; font-size:var(--fs-meta); color:var(--ink); }
  .flow { display:flex; flex-wrap:wrap; align-items:stretch; gap:8px; }
  .fstep { flex:1 1 150px; min-width:140px; border:1.4px solid var(--rule); border-top:3px solid var(--accent);
           border-radius:9px; padding:9px 11px; background:var(--paper); position:relative; }
  .fstep .fn { display:inline-flex; align-items:center; justify-content:center; width:19px; height:19px;
               border-radius:50%; background:var(--accent); color:var(--paper); font-size:var(--fs-micro); font-weight:800; margin-bottom:5px; }
  .fstep b { display:block; font-size:var(--fs-micro); line-height:1.25; margin-bottom:3px; }
  .fstep span { font-size:var(--fs-micro); color:var(--muted); line-height:1.35; }
  .farrow { align-self:center; color:var(--muted); font-size:var(--fs-body); font-weight:700; }
  ...
  .loop-outcome { text-align:center; margin:10px 0 2px; font-size:var(--fs-meta); color:var(--muted); }
  .loop-outcome b { color:var(--accent); }
  .loop .tail { margin:14px 0 0; font-size:var(--fs-micro); color:var(--muted); line-height:1.55; text-align:center; }
  .tail-pair { max-width:760px; margin:8px auto 0; padding-left:20px; }
  .tail-pair li { font-size:var(--fs-micro); color:var(--muted); line-height:1.5; margin:0 0 6px; }
  .refs { margin:0 0 24px; }
  .refs .r { border-left:3px solid var(--accent); padding:3px 0 3px 12px; margin:0 0 7px; font-size:var(--fs-meta); color:var(--muted); }
  .refs .r b { color:var(--muted); font-weight:700; }
  ...
  .lcard { display:block; text-decoration:none; border:1.4px solid var(--line); border-radius:10px;
           padding:13px 15px; background:var(--paper); transition:box-shadow .12s, border-color .12s; }
  .lcard:hover { border-color:var(--rule); }
  .lcard b { display:block; font-size:var(--fs-card-body); color:var(--link); letter-spacing:-.01em; margin-bottom:3px; }
  .lcard span { display:block; font-size:var(--fs-meta); color:var(--muted); line-height:1.4; }
  .lead, .subtitle, .walk-sub, .section-sub, .census-legend { max-width:70ch; }
  .lead { font-size:var(--fs-body); color:var(--ink); line-height:1.66; margin:0 0 13px; }
  ...
  .wf-frame iframe { display:block; border:none; background:var(--paper); }
  .wf figcaption { font-size:var(--fs-meta); color:var(--muted); margin:10px auto 0; text-align:center;
                   max-width:780px; line-height:1.55; }
  hr.sep { border:none; border-top:1px solid var(--line); margin:26px 0 20px; }
  .walk-h { font-size:var(--fs-card-title); margin:0 0 4px; letter-spacing:-.01em; }
  .walk-sub { font-size:var(--fs-card-body); color:var(--muted); margin:0 0 14px; }
  .section-h { font-size:var(--fs-section); margin:24px 0 3px; letter-spacing:-.01em; }
  .section-sub { font-size:var(--fs-card-body); color:var(--muted); margin:0 0 12px; }
  ...
  .school { border:1.4px solid var(--line); border-radius:10px; padding:12px 13px; background:var(--paper); display:flex; flex-direction:column; }
  .school.mid { border:2px solid var(--accent); background:var(--accent-tint); }
  .school h3 { margin:0 0 5px; font-size:var(--fs-body); }
  .school.mid h3 { color:var(--accent); }
  .school p { margin:0 0 9px; font-size:var(--fs-card-body); color:var(--muted); line-height:1.55; }
  .school .srefs { font-size:var(--fs-micro); color:var(--muted); margin:0 0 10px; }
  .school .srefs .lbl { font-weight:700; color:var(--muted); }
  ...
  .school .pole { margin-top:auto; font-size:var(--fs-micro); text-transform:uppercase; letter-spacing:.05em; color:var(--muted); font-weight:800; }
  .spectrum-axis { text-align:center; font-size:var(--fs-micro); color:var(--muted); letter-spacing:.03em; margin:0 0 20px; }
  .cols3 { display:grid; grid-template-columns:repeat(3,1fr); gap:16px; margin:4px 0 8px; }
  .col h3 { margin:0 0 8px; font-size:var(--fs-card-body); padding-bottom:5px; border-bottom:2px solid var(--accent); }
  .col ul { margin:0; padding:0; list-style:none; }
  .col li { font-size:var(--fs-card-body); color:var(--muted); line-height:1.5; margin:0 0 9px; padding-left:15px; position:relative; }
  .col li::before { content:"→"; position:absolute; left:0; color:var(--accent); font-weight:700; }
  .ways-note { font-size:var(--fs-micro); color:var(--muted); margin:2px 0 22px; }
  .mechanisms { display:grid; grid-template-columns:1fr 1fr; gap:14px; margin:4px 0 8px; }
  .mech { border:1.4px solid var(--line); border-left:4px solid var(--accent); border-radius:10px; padding:12px 15px; background:var(--paper); }
  .mech.right { border-left:1.4px solid var(--line); border-right:4px solid var(--accent); text-align:right; }
  .mech h3 { margin:0 0 5px; font-size:var(--fs-card-body); }
  .mech p { margin:0; font-size:var(--fs-card-body); color:var(--muted); line-height:1.55; }
  ...
  .lfig figcaption, .hero-fig figcaption { font-size:var(--fs-meta); color:var(--muted); line-height:1.55;
                   margin:9px auto 0; max-width:70ch; text-align:center; }
  .lfig figcaption b, .hero-fig figcaption b { color:var(--muted); }
  ...
  .board { display:grid; grid-template-columns:repeat(auto-fill, minmax(340px, 1fr)); gap:16px; align-items:stretch;
           margin:6px 0 10px; }
  .box { border:1.4px solid var(--line); border-radius:11px; padding:16px 18px; background:var(--paper);
         display:flex; flex-direction:column; transition:box-shadow .12s, border-color .12s; }
  .box:hover { border-color:var(--rule); }
  .box > :first-child { margin-top:0; }
  .box > :last-child { margin-bottom:0; }
  .box.span2 { grid-column:span 2; }
  .box.spanfull { grid-column:1 / -1; }
  .box.accent { border-top:3px solid var(--accent); }
  .box.tint { background:var(--accent-tint); border-color:var(--rule); }
  .box .bx-h { font-family:var(--font-display); font-size:var(--fs-card-title); margin:0 0 7px;
               letter-spacing:-.01em; }
  .box .bx-h.accent-t { color:var(--accent); }
  .box .bx-eyebrow { font-size:var(--fs-micro); text-transform:uppercase; letter-spacing:.06em; font-weight:800;
                     color:var(--accent); margin:0 0 4px; }
  .box p { font-size:var(--fs-card-body); color:var(--muted); line-height:1.58; margin:0 0 10px; }
  .box p:last-child { margin-bottom:0; }
  .box .term { font-weight:700; color:var(--ink); }
  ...
  .theses-pair { display:grid; grid-template-columns:1fr 1fr; gap:22px; margin:22px 0 8px;
                 align-items:stretch; }
  .thesis { border:1.4px solid var(--line); border-radius:12px; padding:20px 24px 22px; background:var(--paper);
            display:flex; flex-direction:column; }
  .thesis.accent { border-top:3px solid var(--accent); }
  .thesis .th-eyebrow { font-size:var(--fs-micro); text-transform:uppercase; letter-spacing:.07em; font-weight:800;
                        color:var(--accent); margin:0 0 6px; }
  .thesis .th-h { font-size:var(--fs-card-title); margin:0 0 8px; letter-spacing:-.01em; line-height:1.25;
                  font-family:var(--font-display); }
  .thesis .th-sub { font-size:var(--fs-card-body); color:var(--muted); margin:0 0 6px; line-height:1.62; max-width:none; }
  .thesis .th-fig { margin:auto 0 0; padding-top:14px; }
  .thesis .th-fig svg { display:block; width:100%; height:auto; }
  .thesis .th-fig figcaption { font-size:var(--fs-meta); color:var(--muted); line-height:1.55;
                               margin:11px 0 0; text-align:center; max-width:none; }
  .thesis .th-fig figcaption b { color:var(--muted); }
  ...
  .tile { break-inside: avoid; -webkit-column-break-inside: avoid; page-break-inside: avoid;
          ...
          border:1.4px solid var(--line); border-radius:11px; padding:15px 17px; background:var(--paper);
  ...
  .tile.tint { background:var(--accent-tint); border-color:var(--rule); }
  .tile.mid { border:2px solid var(--accent); background:var(--accent-tint); }
  /* Lightweight card headers/kickers — the demoted band H2s become these, no full-width heading rows. */
  .tile .tl-kicker { font-size:var(--fs-micro); text-transform:uppercase; letter-spacing:.07em; font-weight:800;
                     color:var(--accent); margin:0 0 4px; }
  .tile .tl-h { font-family:var(--font-display); font-size:var(--fs-card-title); margin:0 0 6px;
                letter-spacing:-.01em; color:var(--ink); }
  .tile .tl-h.accent-t { color:var(--accent); }
  .tile p { font-size:var(--fs-card-body); color:var(--muted); line-height:1.56; margin:0 0 9px; }
  ...
  .tile .term { font-weight:700; color:var(--ink); }
  .tile .pole { display:block; margin-top:8px; font-size:var(--fs-micro); text-transform:uppercase;
                letter-spacing:.05em; color:var(--muted); font-weight:800; }
  .tile .srefs { font-size:var(--fs-micro); color:var(--muted); margin:8px 0 0; }
  .tile .srefs .lbl { font-weight:700; color:var(--muted); }
  .tile .srefs ul { margin:3px 0 0; padding-left:16px; }
  .tile .srefs li { margin:0 0 2px; line-height:1.4; }
  .tile.axis { text-align:center; font-size:var(--fs-micro); color:var(--muted); letter-spacing:.03em;
  ...
  .tile ul.tl-list li { font-size:var(--fs-meta); color:var(--muted); line-height:1.5; margin:0 0 8px;
  ...
  a.tile b { display:block; font-size:var(--fs-card-body); color:var(--link); letter-spacing:-.01em; margin-bottom:3px; }
  a.tile span { display:block; font-size:var(--fs-meta); color:var(--muted); line-height:1.4; }
  ...
  .tile .r b { color:var(--muted); font-weight:700; }
  /* CTA card. */
  ...
  .card { border:1.4px solid var(--line); border-radius:11px; background:var(--paper); overflow:hidden;
  ...
  .card[open] { border-color:var(--rule); }
  .card.accent { border-top:3px solid var(--accent); }
  .card.tint { background:var(--accent-tint); border-color:var(--rule); }
  .card.mid { border:2px solid var(--accent); background:var(--accent-tint); }
  ...
  .cd-kicker { grid-column:1; font-size:var(--fs-micro); text-transform:uppercase; letter-spacing:.07em;
               font-weight:800; color:var(--accent); margin:0 0 4px; }
  .cd-title { grid-column:1; font-family:var(--font-display); font-size:var(--fs-card-title);
  ...
  .cd-frame { grid-column:1; font-size:var(--fs-meta); color:var(--muted); line-height:1.5; margin:5px 0 0; }
  ...
  .cd-thumb { grid-column:2; grid-row:1 / span 3; width:96px; height:64px; border-radius:7px;
              border:1px solid var(--line); background:var(--panel); overflow:hidden; display:flex;
  ...
  .cd-toggle { grid-column:2; align-self:end; font-size:var(--fs-micro); font-weight:700; color:var(--accent);
  ...
  .cd-body p { font-size:var(--fs-card-body); color:var(--muted); line-height:1.56; margin:0 0 10px; }
  .cd-body p:last-of-type { margin-bottom:10px; }
  .cd-body .term { font-weight:700; color:var(--ink); }
  .cd-body .cd-fig { margin:12px 0 12px; }
  .cd-body .cd-fig svg { display:block; width:100%; height:auto; }
  .cd-body .cd-fig figcaption { font-size:var(--fs-meta); color:var(--muted); line-height:1.5;
                                margin:9px 2px 0; text-align:center; }
  .cd-body .cd-fig figcaption b { color:var(--muted); }
  /* The link-through — always the last thing in an expanded card. */
  .cd-more { display:inline-block; margin-top:4px; font-size:var(--fs-meta); font-weight:700;
  ...
  .cd-body ul.cd-list li { font-size:var(--fs-meta); color:var(--muted); line-height:1.5; margin:0 0 8px;
                           padding-left:15px; position:relative; }
  .cd-body ul.cd-list li::before { content:"→"; position:absolute; left:0; color:var(--accent); font-weight:700; }
  .cd-body .srefs { font-size:var(--fs-micro); color:var(--muted); margin:8px 0 0; }
  .cd-body .srefs .lbl { font-weight:700; color:var(--muted); }
  ...
  .cd-body .pole { display:block; margin:10px 0 0; font-size:var(--fs-micro); text-transform:uppercase;
                   letter-spacing:.05em; color:var(--muted); font-weight:800; }

  /* ---- The four definitions (projected from book/data/definitions.json) --------------------- */
  .cd-body blockquote.def-box { margin:0 0 12px; padding:10px 14px; background:var(--box-def-fill);
                   border-left:var(--border-box-rule) solid var(--box-def-rule); border-radius:0 7px 7px 0; font-size:var(--fs-meta);
                   line-height:1.55; color:var(--ink); }
  .cd-body ul.def-aspects li { font-size:var(--fs-meta); color:var(--muted); }
  .cd-body .def-trace { font-size:var(--fs-micro); color:var(--muted); margin:8px 0 0; }
  .cd-body .def-trace a { color:var(--link); }
  .cd-body .def-owed { color:var(--accent); font-style:italic; }
  ...
  .cd-body ul.oc-list li.oc-row { display:grid; grid-template-columns:auto auto 1fr auto; gap:10px;
                   align-items:baseline; font-size:var(--fs-meta); color:var(--ink); line-height:1.5;
  ...
  .oc-row .oc-more { color:var(--link); white-space:nowrap; font-size:var(--fs-micro); }
  ...
  /* Semantic-box rotation (the decided anchors): the two thesis cards read GREEN on every surface
     (top-bar + kicker), and the definition cards read BLUE (kicker matches their blue def-box). Ordinary
     accent cards keep the umber accent. */
  .theses-cards .card.accent { border-top-color:var(--box-thesis-rule); }
  .theses-cards .cd-kicker, .theses-cards .cd-title.accent-t { color:var(--box-thesis-rule); }
  .def-card .cd-kicker { color:var(--box-def-rule); }

  /* A card-family block: a light kicker heading over a masonry pack of its cards. */
  .fam { margin:0 0 6px; }
  .fam-h { font-size:var(--fs-meta); text-transform:uppercase; letter-spacing:.06em; font-weight:800;
           color:var(--muted); margin:20px 0 12px; padding-bottom:6px; border-bottom:1px solid var(--line); }
...
def _landing_outcomes() -> str:
    ...
    return (
        '<details class="card wide accent" id="outcomes-view">\n'
...
LANDING_INTRO = """  <!-- ===================== HERO =====================
  ...
  <div class="hero">
    <div class="hero-lead">
      ...
      implementation toward one built around abundant, low-cost code. The hard part
      ...
      <p class="lead">MAGE is one method with two theses —
      a Modeling Thesis and an Alignment Thesis — and this page is built around them. Every unit
  ...
  <div class="fam">
    ...
    <div class="masonry">
    <details class="card wide accent" id="card-universal-language">
      <summary>
