...
LANDING_INTRO = """  <div class="tag">Pattern catalogue</div>
  ...
  Judgment: A Case Study on Governable Agentic Software Engineering</i></a>. Identities are redacted;
  the mechanisms are real.</p>
  <ul style="list-style:none;padding:0;margin:0 0 22px;font-size:14px;">
  ...
  <li><a href="https://github.com/davisjam/agent-governance-mechanisms">▸ Browse the source on GitHub</a>
