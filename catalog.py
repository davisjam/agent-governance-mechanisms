...
LANDING_CSS = """
  ...
  .nav-grid .ng-cell { display:flex; flex-direction:column; justify-content:center; gap:1px;
              border:1.6px solid #cbd5e1; border-radius:10px; padding:7px 13px; background:#fff;
              text-decoration:none; color:var(--ink); transition:border-color .12s, background .12s; }
  .nav-grid .ng-cell:hover { border-color:var(--accent); background:#fffaf3; }
  .nav-grid .ng-t { font-size:14px; font-weight:700; color:var(--link); letter-spacing:-.01em; }
