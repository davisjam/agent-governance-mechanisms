...
LANDING_INTRO = """  <div class="tag">Governance-centric agentic software engineering</div>
  ...
  <ol class="two-directions">
    <li><b>Up front</b>, you specify what you can: the architecture that makes a class of error impossible,
    the model the fleet reasons through (more on that below), the templates and checklists that put a change
    on rails before it's written.</li>
    <li><b>In flight</b>, you let velocity surface the failures you couldn't foresee, and convert each
    recurring one into a durable guardrail.</li>
  </ol>
