...
MODEL_NODES = [
    ...
    {"k": "trunk", "spine": "trunk", "title": "The method trunk",
     ...
     "perim": ["executable-source-of-truth", "drift-parity-gates", "agent-first-mbse-harness",
               ...
               "model-derived-test-obligation-census"]},
]
...
LANDING_CSS = """
  ...
  .s-claim { font-size:var(--fs-card-body); color:var(--muted); line-height:1.62; margin:0 0 10px; max-width:62ch; }
  ...
  .idea-hero .ih-words .s-claim { max-width:78ch; margin-left:auto; margin-right:auto; }
