...
*Its place in the environment — a **variant / known-use** of **Governance Graph**, under **GOVERN · Govern the control estate itself**. Preserved here for its technical texture; the [construction kit](../../constructing-the-gee.md#cap-govern) shows how it folds.*
