...
records** — adopting the *vocabulary and schema* of the right modeling genre per view, but skipping its
runtime and hand-rolling the executable layer — so the model captures your project's own invariants and
